...
class MoodleClient(object):
    ...
    def upload_file(self,file,evidence=None,itemid=None,progressfunc=None,args=(),token=False,xdlink=False):
        try:
            ...
            if xdlink:
            	urls = data['url']
            	linker = XDLink.parse(urls)
            	data['url'] = linker
            return itempostid,data
        except:
            return None,None

    def upload_file_blog(self,file,blog=None,itemid=None,progressfunc=None,args=(),token=False,xdlink=False):
        try:
    ...
    def upload_file_perfil(self,file,progressfunc=None,args=(),token=False,xdlink=False):
    ...
    def upload_file_draft(self,file,progressfunc=None,args=(),token=False,xdlink=False):
    ...
    def upload_file_calendar(self,file,progressfunc=None,args=(),token=False,xdlink=False):
